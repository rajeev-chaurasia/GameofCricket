...
import com.tekion.repo.MatchRepository;
import com.tekion.repo.MatchRepositoryImpl;
...
//        this.displayResult();
    ...
    private void setTeamInfo() {
        cricketGame.setTeam1(new Team(teamService.inputTeam1Details()));
        cricketGame.setTeam2(new Team(teamService.inputTeam2Details()));
    ...
    private void playInning(int inning , Team teamBatting){
    ...
    private void playOver(int inning , int matchOvers , Team teamBatting){
        int ballScore;
...
//        }
    ...
    private int playBall(int matchOvers , Player currentBatsman) {
        int runScored = MatchCalculationsUtils.eachBallScore(matchOvers, currentBatsman);
        return runScored;
    }

    private void PlayerStatUpdateAndStrikeChange(int inning , int runScored , Player currentBatsman , Team teamBatting ){
